...
public class DriverEntity implements Serializable {
    ...
    public DriverEntity(int id, String phone, String password, String name, int sex, String place, float evaluate, String identify_number, String information, String head_url, String identify_image_url, String trainer_image_url, int taught_people, float unit_price) {
        this.id = id;
        this.phone = phone;
